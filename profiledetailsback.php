...
<body>
    <div class="left-container">
		...
		<hr></hr>
		<a href="dashdent.html"	 class="dashboard1st" id="notactive"><img src="dash.png" class="icons"><span class="dashtext">Dashboard</span></a>
		<a href="appdent.html"	 class="dashboard2" id="notactive"><img src="app.png" class="icons"><span class="dashtext">Appointment</span></a>
		<a href="profdent.html"	 class="dashboard3" id="active"><img src="profile.png" class="icons"><span class="dashtext">Profile</span></a>
		<a href="docdent.html"	 class="dashboard4" id="notactive"><img src="doc.png" class="icons"><span class="dashtext">Doctors</span></a>
		<a href="patdent.html"	 class="dashboard5" id="notactive"><img src="pat.png" class="icons"><span class="dashtext">Patients</span></a>
		<a href="logout.html"	 class="dashboard6" id="notactive"><img src="logout.png" class="logouticons"><span class="dashtextlogout">Logout</span></a>
    </div>
			   ...
			   <div class="container">
						...
						<div class="overlap-container">
								...
								<div class="detailsbot"><div class="minibox"><span class="smoltext">First Name</span>
																				<input type="text" class="field" name="fname" value="<?php echo $row["firstName"]?>"></input>
						...
						<div class="overlap-container1">
								<a href="profilepicture.php?id=<?php echo $id; ?>"><div class="profpictop"><span class="textdetails">Profile Picture</span></div></a>
								<div class="profpicbot"><div class="minibox2"><span class="smoltext">Middle Name</span>
																				<input type="text" class="field" name="mname" value="<?php echo $row["middleName"]?>"></input>
																				
								</div>
								
								<div class="minibox3"><span class="smoltext">Last Name</span>
																				<input type="text" class="field" name="lname" value="<?php echo $row["lastName"]?>"></input>
																				
								</div>
								<div class="minibox5"><span class="smoltext">Contact Number</span>
																				<input type="text" class="field" maxlength="11" id="customInput" oninput="restrictInput()" name="cnumber" value="<?php echo $row["contactNumber"]?>">
								...
								<div class="minibox7"><span class="smoltext">E-mail</span>																				
																				<div class="field-container">
																							<input type="text" class="field1" name="email" value="<?php echo $row["email"]?>"></input>
																						</div>
								</div>
								...
								<div class="minibox8"><span class="smoltext">Address</span>																				
																				<div class="field-container">
																							<input type="text" class="field2" name="address" value="<?php echo $row["address"]?>"></input>
																						</div>
								</div>
