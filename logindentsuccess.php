...
<span class="message1" style="">Login Successful!</span>

<form action="dashdent.php" method="post"><input type="hidden" name="id" value="<?php echo $id ?>"></input><div class="rectangle"><button class="buttonok" type="submit">OK</button></div></form>
</div>
  <div class="fixed-resolution">
	...
	<div class="textbox"><form action="logindent.php" method="post"><input class="uname" type="text" placeholder="E-mail" name="username" required></input></div>
...
<div class="middle"></div>
	<div class="right">
		...
		<div class="loginbut1"><form action="regdent.html"><button>Register</button></form></div>
		</div>
