...
<body>
    <div class="left-container">
		...
		<hr></hr>
		<a href="dashdent.html"	 class="dashboard1st" id="active"><img src="dash.png" class="icons"><span class="dashtext">Dashboard</span></a>
		<a href="appdent.html"	 class="dashboard2" id="notactive"><img src="app.png" class="icons"><span class="dashtext">Appointment</span></a>
		<a href="profdent.html"	 class="dashboard3" id="notactive"><img src="profile.png" class="icons"><span class="dashtext">Profile</span></a>
						...
						<div class="con"><div class="darkgreypart">
										...
										if ($result->num_rows > 0) {
											while($row = $result->fetch_assoc()) {
												...
												echo '<button class="delete-btn" onclick="deleteRecord(' . $row["booking_id"] . ')"><img src="delete.png"></button>';
												echo "</div>";
											}
											...
											?>
											<div class="bottom"><div style="width:240px;height:54px;border-radius:5px;background-color:#3498DB; display:flex;align-items:center; justify-content:center;"><span style="font-family:Anton; font-size:20px; color:#FFFFFF;">Create New Appointment</span></div>
										<div class="prev" ><span style="font-family:Anton;font-size:20px;color:#3498DB;"><</span></div><div class="next"><span style="font-family:Anton;font-size:20px;color:#3498DB;">></span></div></div>
										<script>
