...
#doctorsBox:not(:hover) {
    cursor: default; /* Set the default cursor for doctorsBox when not hovering */
}

#doctorsBox:hover .ellipse-wrapper {
    cursor: default; /* Set the default cursor for the ellipse when hovering doctorsBox */
}

#doctorsBox:hover {
    cursor: pointer; /* Set the pointer cursor for doctorsBox when hovering */
}
a{
	text-decoration:none;
}
...
<body>
    <div class="left-container">
        <a href="dashdent.php"><img src="logo.png" style="width:27px; height:27px; display:block; margin:14px auto 0;"></a>
		<a href="dashdent.php"><span class="logotext">GOLDEN DENTAL</span></a>
    ...
    <div class="right-container">
        ...
        <div class="bottom-section">
            <div class="margintop">
                <div class="box1 doctors-box" id="doctorsBox">
				
				
                    <a href="doctors.php?id=<?php echo $id; ?>"><span class="text">DOCTORS</span>
                    <span class="text2"><?php echo $totalDoctors ?></span></a>
                    <div class="ellipse-wrapper">
                        <div class="ellipse-2">
						<a href="your-link-url" class="ellipse-link"></a>
						<a href=""><img src="but1.png" class="ellipse-img"></a>
						</div>
                    </div>
                </div>
				<script>
    // Get the box element
    var doctorsBox = document.getElementById('doctorsBox');

    // Add a click event listener to the box
    doctorsBox.addEventListener('click', function(event) {
        // Check if the clicked element is the box itself (not the ellipse)
        if (event.target === doctorsBox) {
            // Navigate to the specified link
            window.location.href = 'doctors.php?id=<?php echo $id; ?>';
        }
    });

</script>
				<div class="box2">
                    <a href=""><span class="text">PATIENTS</span>
                    <span class="text2">11</span></a>
                    <div class="ellipse-wrapper">
                        <div class="ellipse-2">
						<a href="" class="ellipse-link">
						<img src="but2.png" class="ellipse-img"></div></a>
                    </div>
                </div>
				<div class="box3">
                    <a href="appointment1.php?id=<?php echo $id; ?>"><span class="textnewly">NEWLY BOOKED</span>
                    <span class="text2"><?php echo $countToday ?></span></a>
                    <div class="ellipse-wrapper">
                        <div class="ellipse-2">
						<a href="appointment1.php?id=<?php echo $id; ?>" class="ellipse-link">
						<img src="but3.png" class="ellipse-img"></div></a>
                    </div>
                </div>
				<div class="box4">
                    <a href="appointment1.php?id=<?php echo $id; ?>"><span class="texttoday">TODAY'S APPOINTMENTS</span>
                    <span class="text2">11</span></a>
                    <div class="ellipse-wrapper">
                        <div class="ellipse-2">
						<a href="appointment1.php?id=<?php echo $id; ?>" class="ellipse-link">
			...
			<div class="session-container">
				...
				<span style="margin-left:16px;
						...
						font-style: normal;
						font-weight: 700;
						line-height: normal;">Appointment Number</span>
				<span class="headingfirst" style="display: flex;
						width: 191px;
						height: 65px;
						flex-direction: column;
						justify-content: center;">Patient Name</span>
				<span class="headingfirst" style="display: flex;
						width: 107px;
						height: 65px;
						flex-direction: column;
				...
				<span class="headingfirst" style="display: flex;
						...
						height: 65px;
						flex-direction: column;
						justify-content: center;">Contact Number</span>
				<span class="headingfirst" style="display: flex;
						width: 222px;
						height: 65px;
						flex-direction: column;
						justify-content: center;">Service/Procedure</span>
				</div>
				...
				<span class="heading" style="display: flex;
						...
						height: 65px;
						flex-direction: column;
						justify-content: center;">Contact Information</span>
				<span class="heading" style="display: flex;
						width: 222px;
						height: 65px;
						flex-direction: column;
